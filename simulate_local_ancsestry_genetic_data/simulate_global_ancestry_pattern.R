################################################
## R function to generate global ancestry proportion for each individual
## here we use 3-way admixed population for example
## generate an n by 3 matrix representing a 3-way admixed population
## each row provides the global ancestry proportion of an individual 
## multiple admixture patterns are implemented
################################################


simulate_global_ancestry_pattern <- function(n, pattern = "realistic_admixture"){
